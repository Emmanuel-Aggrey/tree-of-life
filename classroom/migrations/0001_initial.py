    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_leader', models.BooleanField(default=False, verbose_name='is leader')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', models.ManyToManyField(help_text='available topics', related_name='interested_students', to='classroom.Subject')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quizzes', to='classroom.Subject', verbose_name='topic')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.AddField(
            model_name='user',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='classroom.ChurchGroups'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taken_quizzes', to='classroom.Student', verbose_name='Member')),
            ],
        ),
        migrations.CreateModel(
            name='StudentAnswer',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_answers', to='classroom.Student', verbose_name='Member')),
            ],
        ),
        migrations.AddField(
            model_name='student',
